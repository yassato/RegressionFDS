...
Similarly to the split subpopulation case, we convert genotypes into digit in a case of continuous space. The genotype similarity the a continuous space can be calculated using `nei_coval` function in `rNeighborGWAS` package, as follows.
```{r gsim2}
d2$gi[d2$gi=="A"] = 1
d2$gi[d2$gi=="a"] = -1
